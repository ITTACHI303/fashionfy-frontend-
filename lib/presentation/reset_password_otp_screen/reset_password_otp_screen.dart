import 'package:ai_measurement/core/utils/keys.dart';
import 'package:ai_measurement/presentation/reset_password_otp_screen/reset_password_controller/reset_password_controller.dart';
...
class ResetPasswordOtpScreen extends StatefulWidget {
  ResetPasswordOtpScreen({Key? key})
      : super(
          key: key,
        );
...
class _ResetPasswordOtpScreenState extends State<ResetPasswordOtpScreen> {
  ...
  void initState() {
    ...
    if (arguments is Map<String, dynamic>) {
      final navigatedFrom = arguments[Keys.keyNavigatedFrom] ?? '';
      resetPasswordController.navigatedFrom.value = navigatedFrom;
      input = arguments['data']?.toString();
      print(input);
    } else {
      input = null;
    }
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          ...
          Text(
            resetPasswordController.navigatedFrom.value == Keys.keyEmail
  ...
  onTapVerify(BuildContext context) {
    print(input);
    resetPasswordController.resetPasswordApi(context, input);
  }
}
