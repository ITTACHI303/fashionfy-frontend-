...
class ForgotPassword1bScreen extends StatelessWidget {
  ForgotPassword1bScreen({Key? key})
      : super(
          key: key,
        );
  ...
  onTapInputone() {
    Get.offNamed(AppRoutes.forgotPassword1aScreen);
  }

  /// Navigates to the resetEmailOtpScreen when the action is triggered.
  onTapNext() {
    Get.toNamed(AppRoutes.resetPasswordOtpScreen,
        arguments: {Keys.keyNavigatedFrom: Keys.keyPhone, 'data': data});
  }
