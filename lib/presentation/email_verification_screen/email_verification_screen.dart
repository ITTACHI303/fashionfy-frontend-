import 'package:ai_measurement/presentation/email_verification_screen/email_verification_controller/email_verification_controller.dart';
...
class EmailVerificationScreen extends StatelessWidget {
  ...
  Widget _buildColumnsingup(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        children: [
          Text(
            StringResources.strVerification.tr,
            maxLines: 1,
          ...
          Pinput(
            length: 6,
            controller: emailVerificationController.otpController,
  ...
  onTapVerify(BuildContext context) {
    if (emailVerificationController.otpController.text.isNotEmpty) {
      emailVerificationController.emailVerificationApi(context, email);
    }
  }
}
